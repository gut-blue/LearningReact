...
// Basically this is the TEMPLATE for the BandList function
// it will pass in each part of the object according to the
// spread operator following this template.
function Band({
  name,
  members,
  formed,
